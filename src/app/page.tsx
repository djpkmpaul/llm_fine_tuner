    ...
    <div
      ...
      >
        <BackgroundBeamsWithCollision className="flex flex-col">
          <h2 className="relative z-20 md:text-4xl lg:text-7xl font-mono font-extrabold text-center text-black dark:text-white tracking-tight">
            <span className="text-6xl">Welcome to LLM {" "}</span>
            <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
              <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 from-purple-500 via-violet-500 to-pink-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">
                <span className="text-6xl font-mono font-extrabold">Fine-tuner.</span>
              </div>
          ...
          <p className="text-2xl mt-3 mb-9 max-w-5xl text-justify font-mono">
            <span className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-zinc-800 via-bl to-zinc-800 py-4">Context Aware Fine-Tuning of LLM.</span> Enhance your Language Models with our state-of-the-art fine-tuning platform.
            Improve <span className="accuracy"> accuracy</span>, adapt to specific domains, and unlock new possibilities.
          </p>
          <div className="mt-5 space-x-4">
            <Button className='h-12 text-lg bg-zinc-700' asChild>
          ...
          <Button variant="default" className="h-12 text-lg mt-36 animate-bounce bg-zinc-700" size="lg" asChild>
            <Link href="#card">
              <ChevronDown />
            </Link>
          </Button>
      ...
      <HeroHighlight>
        <div className="stats h-[135vh]">
          <div className="flex flex-col w-[100vw] min-h-screen justify-center items-center">
            <Card id="card" className="p-6 mb-3">
              <CardHeader>
                <CardTitle>
                  <h1 className="text-5xl relative z-20 font-bold text-center text-black dark:text-white font-mono tracking-tight">Why Fine Tune?</h1>
                </CardTitle>
              </CardHeader>
              <CardContent className="flex flex-col items-center">

                <p className="p-3 max-w-[1100px] text-justify text-2xl relative z-20 text-black dark:text-white font-mono tracking-tight">
                  Fine-tuning is the secret to transforming your models from good to great. It's the key to unlocking their full potential, enabling them to adapt specifically to your unique data and goals. Just like how a skilled artist refines their masterpiece, fine-tuning tailors pre-trained models to deliver maximum accuracy and efficiency for your specific needs.By fine-tuning, you can significantly enhance performance without needing to start from scratch. It's cost-effective, fast, and provides the flexibility to adapt to new challenges. With fine-tuning, your models become smarter, more precise, and better equipped to handle real-world complexity.
                  See the difference in action below with charts and illustrations that showcase how fine-tuning boosts precision, minimizes errors, and maximizes the value of your model. Fine-tuning is the powerful tool that takes your model to the next level—perfecting it for your business, your data, and your goals.
                </p>
